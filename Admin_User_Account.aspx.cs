...
public partial class Admin_User_Account : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataSource1.SelectCommand = "SELECT U_No,U_Name,U_Address,U_Contact,U_Email,U_Image,A_Status FROM User_Details ORDER BY U_No DESC";
    }
    ...
    {
        SqlDataSource1.SelectCommand = "SELECT U_No,U_Name,U_Address,U_Contact,U_Email,U_Image,A_Status FROM User_Details where " + DropDownList2.SelectedItem.Text + "='" + TextBox6.Text + "' ORDER BY U_No DESC";
    }
