<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Stock_Screener.aspx.cs" Inherits="Stock_Screener" %>
...
<form id="form1" runat="server">
    ...
    <br />
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
            ...
            <asp:ListItem>Up by 5%</asp:ListItem>
            <asp:ListItem>Down by 5%</asp:ListItem>
            <asp:ListItem>Up by 10%</asp:ListItem>
            <asp:ListItem>Down by 10%</asp:ListItem>
        </asp:DropDownList>&nbsp;<br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC"
            ...
            DataSourceID="SqlDataSource1" ForeColor="Black" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="887px">
            <FooterStyle BackColor="#CCCCCC" />
            <Columns>
                <asp:CommandField ShowSelectButton="True" />
                <asp:BoundField DataField="Scrip_Name" HeaderText="Scrip_Name" SortExpression="Scrip_Name" />
                <asp:BoundField DataField="SOpen" HeaderText="SOpen" SortExpression="SOpen" />
                <asp:BoundField DataField="SHigh" HeaderText="SHigh" SortExpression="SHigh" />
                <asp:BoundField DataField="SLow" HeaderText="SLow" SortExpression="SLow" />
                <asp:BoundField DataField="SClose" HeaderText="SClose" SortExpression="SClose" />
                <asp:BoundField DataField="SLast" HeaderText="SLast" SortExpression="SLast" />
                <asp:BoundField DataField="SPClose" HeaderText="SPClose" SortExpression="SPClose" />
                <asp:BoundField DataField="SNoTrade" HeaderText="SNoTrade" SortExpression="SNoTrade" />
                <asp:BoundField DataField="SNoShare" HeaderText="SNoShare" SortExpression="SNoShare" />
                <asp:BoundField DataField="STurnover" HeaderText="STurnover" SortExpression="STurnover" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:KMSConnectionString %>"
            SelectCommand="SELECT * FROM [Stock_Temp]"></asp:SqlDataSource>
        <br />
            <br />
