...
public partial class Retrive_Password : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Count(*) from User_Details where U_No='" + TextBox1.Text + "' and U_Email='" + TextBox2.Text + "' and Password_Hint='" + TextBox3.Text + "'";
        ...
        else
        {
            cn.Open();
            cmd.Connection = cn;
            cmd.CommandText = "select Password from User_Login where Username='" + TextBox1.Text + "'";
            rs = cmd.ExecuteReader();
            while (rs.Read())
            {
